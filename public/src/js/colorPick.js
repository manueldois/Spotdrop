...
(function( $ ) {
    ...
    $.colorPick.prototype = {
        ...
        show: function(left, top) {
	        ...
	        $("body").append('<div id="colorPick" style="display:none"><span>'+$.fn.colorPick.defaults.paletteLabel+'</span></div>');
            ...
            var height = $("#colorPick").height()
            var width = $("#colorPick").width()
            $("#colorPick").css({"top" : (top-height)+"px","left" : (left-width)+"px"})
