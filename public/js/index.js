    ...
    if(drop.best_post == null){
        contentString = '<div class="map-iw" data-owner="'+drop.owner._id+'">'+
                            ...
                            '<div class="map-iw-body mt-2">'+
                                ...
                                '<div class="map-iw-img" data-drop='+ drop_id + ' data-post='+ post_id + ' data-img='+img_num+' style="background-image: url('+drop.creation_post.images[0]+');" >'+
                                '</div>'+
...
// Color picker
$("#color-hashtag").colorPick({'allowCustomColor': true
